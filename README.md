...
**Dự án Phân tích Dữ liệu & Học máy**  
...
[GIỚI THIỆU](#1-giới-thiệu) • [TÍNH NĂNG](#2-tính-năng--phân-tích) • [CÔNG NGHỆ](#3-công-nghệ-sử-dụng) • [CÀI ĐẶT](#5-hướng-dẫn-cài-đặt) • [INSIGHTS](#6-key-insights)
...
| Khác | Requests, BeautifulSoup (Scraping), Haversine Formula |
...
```bash
git clone https://github.com/your-username/athens-airbnb-analysis.git
